 ...
 */
final class Version20250512235900 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE user_mailling ADD CONSTRAINT FK_8EE7074AA76ED395 FOREIGN KEY (user_id) REFERENCES users_adn (id) ON UPDATE NO ACTION ON DELETE NO ACTION
        SQL);
        $this->addSql(<<<'SQL'
